...
def expand_bbox_regression_targets(bbox_targets_data, points_targets_data, num_classes, cfg):
    """
    ...
    points_targets = points_targets_data
    points_weights = np.zeros(points_targets.shape, dtype=np.float32)
    ...
    for index in indexes:
        ...
        points_weights[index, :] = cfg.TRAIN.POINTS_WEIGHTS
    return bbox_targets, bbox_weights, points_targets, points_weights
