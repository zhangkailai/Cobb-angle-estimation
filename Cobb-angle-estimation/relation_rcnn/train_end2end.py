...
def my_load_gt_roidb(image_set, dataset_path, flip):
    path = os.path.join(dataset_path, image_set)
...
#    else:
#        roidbs = [my_load_gt_roidb(image_set, config.dataset.dataset_path, flip=config.TRAIN.FLIP) for image_set in image_sets]
#        roidb = merge_roidb(roidbs)
#        print len(roidb)
#        roidb = filter_roidb(roidb, config)
