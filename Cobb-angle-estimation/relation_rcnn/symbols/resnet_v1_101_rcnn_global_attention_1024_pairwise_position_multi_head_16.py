...
class resnet_v1_101_rcnn_global_attention_1024_pairwise_position_multi_head_16(resnet_v1_101_rcnn_base):
    def __init__(self):
        """
...
#            rois, label, bbox_target, bbox_weight = mx.sym.Custom(rois=rois, gt_boxes=gt_boxes_reshape,
        ...
        attention_1 = self.attention_module_multi_head(global_feature, fc_new_1, position_embedding,
        ...
        attention_2 = self.attention_module_multi_head(global_feature, fc_new_2, position_embedding,
                                                       nongt_dim=nongt_dim, fc_dim=16, feat_dim=1024,
                                                       index=2, group=16,
                                                       dim=(1024, 1024, 1024))
